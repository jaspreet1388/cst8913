...
| 30 | A real-time communication service used for sending notifications, emails, and text messages to users and devices. | Amazon SNS | Azure Notification Hubs | Firebase Cloud Messaging (FCM) & Pub/Sub |
